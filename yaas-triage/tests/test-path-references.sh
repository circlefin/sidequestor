...
# (`yaas-triage/add-watch.py` and friends). Most are ordinary code, but a large share sit
...
EXCLUDE_RE='^(\.git/|node_modules/|\.local/|logs/|state/|yaas-robustness-plan\.md|documentation-complaints\.md|docs/)'
