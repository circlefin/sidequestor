...
for spec in \
  ...
  if python3 yaas-triage/ledger/add-watch.py q1 "$body" >/dev/null 2>&1; then
...
python3 yaas-triage/ledger/add-watch.py nosuchquest '{"type":"slack_channel","channel_id":"C1","reason":"r"}' >/dev/null 2>&1 \
