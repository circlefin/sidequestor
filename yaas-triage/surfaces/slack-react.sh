#!/bin/bash
# slack-react.sh — add/remove a Slack reaction.
#
...
# call it by this name. Prefer: python3 yaas-triage/surfaces/client.py slack-react ...
exec python3 "$(dirname "$0")/client.py" slack-react "$@"
