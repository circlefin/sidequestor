# YAAS Worker Operating Instructions

This file is installed and managed by the YAAS package. Read it before acting on a
triage dispatch.
...
```text
python3 "$YAAS_RUNTIME_ROOT/yaas-triage/ledger/ack-watch.py" ack <run_id> <item_id> handled|nothing_to_do|blocked "<note>"
```
...
remain in force, but this file owns the YAAS runtime boundary and dispatch protocol.
